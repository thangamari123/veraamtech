...
const Navbar = () => {
  ...
  return (
    <header className="fixed top-4 left-0 right-0 z-50 px-4 md:px-8 flex justify-center w-full transition-all duration-300">
      {/* Pill Container */}
      <div className="w-full max-w-[1400px] bg-white rounded-2xl shadow-[0_4px_20px_rgba(0,0,0,0.05)] border border-gray-100 px-6 py-3 flex items-center justify-between">
        
        {/* Logo */}
        <Link to="/" className="flex flex-shrink-0 items-center space-x-3">
          <img src={logo} alt="VEERAAM TECH Logo" className="h-10 md:h-12 object-contain" />
          <div className="flex flex-col justify-center">
            <span className="text-xl md:text-2xl font-heading font-black tracking-tighter leading-none mb-1">
            ...
            <span className="text-[8px] md:text-[9px] tracking-[0.2em] text-gray-500 font-semibold uppercase mt-0.5">
        ...
        {/* Mobile Menu Button */}
        <button
          className="xl:hidden text-gray-900 bg-gray-50 p-2 rounded-md"
